...
By downloading or using Sonobender ("the app"), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the app.

## Description of Service

Sonobender is a mobile application that allows you to play a theremin-style musical instrument using hand gestures captured by your device's camera.
...
- All purchases are final and processed through Apple
...
- The free version of the app contains advertisements
- You may watch rewarded ads to earn virtual currency or ad-free time
- Ad-related data is collected as described in our Privacy Policy

## Virtual Currency (Coins)

- Coins can be earned through rewarded ads or purchased
- Coins have no real-world monetary value
- Coins are non-refundable and non-transferable
- We reserve the right to modify coin values or availability

## Intellectual Property

All content, features, and functionality of the app are owned by us and protected by copyright, trademark, and other intellectual property laws.
...
We may terminate or suspend your access to the app at any time, without prior notice, for conduct that we believe violates these Terms or is harmful to other users.
